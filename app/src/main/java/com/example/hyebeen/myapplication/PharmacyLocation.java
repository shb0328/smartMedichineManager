...
public class PharmacyLocation extends AppCompatActivity
        ...
        LocationListener,PlacesListener
{
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                .listener(PharmacyLocation.this)
                .key("AIzaSyDB-6_WEsv4OkXHUyxQxlz-BzSIwbgAeG8")
    ...
    private void showDialogForPermission(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PharmacyLocation.this);
        builder.setTitle("알림");
